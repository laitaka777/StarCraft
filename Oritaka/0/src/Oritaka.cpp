...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	for( std::set<Unit*>::const_iterator i = Broodwar->self()->getUnits().begin(); i != Broodwar->self()->getUnits().end(); i++ )
	{
		...
		if ( table_task[id].order == task_build_supply_depot   && (*i)->getOrder() != Orders::ConstructingBuilding ) mineral_reserve += 100; // for Supply_Depot	
		if ( table_task[id].order == task_build_command_center && (*i)->getOrder() != Orders::ConstructingBuilding ) mineral_reserve += 400; // for Command Center
		if ( table_task[id].order == task_build_barracks && (*i)->getOrder() != Orders::ConstructingBuilding ) mineral_reserve += 100; // for Barracks
		//if ( table_task[id].order == task_build_refinary && (*i)->getOrder() != Orders::ConstructingBuilding ) mineral_reserve += 400; // for Refinary
	} 
